#
#  Be sure to run `pod spec lint GZBaseTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "郭振涛"
  # s.authors            = { "郭振涛" => "" }
  # s.social_media_url   = "http://twitter.com/郭振涛"
